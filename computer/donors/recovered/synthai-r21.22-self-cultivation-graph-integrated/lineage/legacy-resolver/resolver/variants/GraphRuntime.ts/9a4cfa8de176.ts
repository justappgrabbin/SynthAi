...
import { RuntimeLearningCoordinator } from './RuntimeLearningCoordinator';
import type { TeachingExample, TestCase, Feedback } from './InteractiveLearner';
...
export class GraphRuntime {
  ...
  private learningCoordinator: RuntimeLearningCoordinator;
  ...
  constructor() {
    ...
    this.artifactAssembler = new ArtifactAssembler(this.toolRegistry, () => this.getLearningSnapshot());
  ...
  teach(example: TeachingExample): TestCase {
