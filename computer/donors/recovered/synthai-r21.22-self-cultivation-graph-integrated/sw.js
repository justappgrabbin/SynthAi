const CACHE='synthia-r19-shell-v1';
const SHELL=['./','./index.html','./styles.css','./app.mjs','./manifest.webmanifest','./browser/KnowledgeVault.mjs','./browser/ValidatedLearningStore.mjs','./browser/LearningMesh.mjs','./browser/MCPChairClient.mjs'];
