...
const calls = new Map([
  ...
  ['buildPurposeRoadmap', args => runtime.buildPurposeRoadmap(...args)],
  ['recordPurposeOutcome', args => runtime.recordPurposeOutcome(...args)],
  ['getPurposeRoadmap', args => runtime.getPurposeRoadmap(...args)],
  ['scoreTaskFit', args => runtime.scoreTaskFit(...args)],
  ['rankTaskFitCandidates', args => runtime.rankTaskFitCandidates(...args)],
