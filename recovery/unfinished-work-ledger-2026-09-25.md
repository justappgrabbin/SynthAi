...
6. **Correct stale status records.** The September 10 Notion “START HERE — Synthia Control Panel” states no current APK binary. PR #10 now records an assembled candidate as of September 25. Update the Notion record once its provenance and location are verified; retain the crucial distinction between built APK and phone-verified release. The Notion page also references an earlier YORK fresh-install base; compare that contract with the candidate rather than assuming lineage identity.
