...
## September 25 continuation — in-app Computer phone acceptance

- [PR #24](https://github.com/justappgrabbin/SynthAi/pull/24) adds a one-tap Phone Acceptance panel to PR #23's visible Computer Home. Its copyable report records Android host, visible Home, embedded Linux backend status/services, project counts, an observed app reopen, and the creator's explicit acceptance checkbox. States remain distinct: pending, user-access-verified, and phone-accepted. Phone acceptance requires visible Android Home, verified backend, restart evidence, and creator acceptance.
- The first full run correctly failed because the new report module was absent from APK staging (`ASSET_MISSING computer-runtime/phone-acceptance-report.mjs`). Commit `5468375` added it to the build manifest. [Clean full run 36218663839](https://github.com/justappgrabbin/SynthAi/actions/runs/36218663839) then passed 83/83 tests, APK payload checks, Mobile SynthIMG, and emulator `COMPUTER_HOME_VISIBLE=true`.
- [Computer APK artifact 10898645582](https://github.com/justappgrabbin/SynthAi/actions/runs/36218663839/artifacts/10898645582) is the current phone-acceptance candidate. APK SHA-256: `381f7485bb149534d7b2663180d97c19318a3f846b66e3093783fee2d7a53fbc`. State: built, GitHub-preserved, emulator-visible, and downloadable. Creator access to this exact artifact and physical ARM64 phone acceptance remain open until the in-app report is returned. This is Computer/Venom lineage; Prime 5.8 remains separate and still needs the exact Resident 3 bytes. Supabase RLS findings remain open by creator instruction.
